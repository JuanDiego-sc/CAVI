                ...
                <div className={styles.footerContent}>
                    <div className={styles.footerMain}>
                        <div className={styles.footerBrand}>
                            ...
                            <p className={styles.brandDescription}>
                                Centro de Atención Veterinaria Integral especializado en fauna silvestre y animales exóticos.
                            </p>
                            ...
                            <div className={styles.footerColumn}>
                                ...
                                <ul className={styles.linkList}>
                                    <li className={styles.contactItem}>
                                        ...
                                        <a href={`tel:${contactContent.phone}`} className={styles.footerLink}>
                                            {contactContent.phone}
                                        </a>
                                    </li>
                                    <li className={styles.contactItem}>
                                        <span className={styles.contactIcon}>✉️</span>
                                        <a href={`mailto:${contactContent.email}`} className={styles.footerLink}>
                                            {contactContent.email}
                                        </a>
                                    </li>
                                    <li className={styles.contactItem}>
                                        <span className={styles.contactIcon}>📍</span>
                                        <span className={styles.footerText}>{contactContent.address}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className={styles.footerBottom}>
                        <p className={styles.copyright}>
                            © {currentYear} CAVI - Centro de Atención Veterinaria Integral. Todos los derechos reservados.
                        </p>
                    </div>
                </div>
            </Container>
